...
module.exports = (robot) ->
  ...
  robot.hear /(女の子|女性|若い子|美人)/i,(msg) ->
    name=msg.match[1]
    msg.send "#{name}大好き"
...
#    ]
  ...
  cards = {
    ...
    "大得点系":
      "num": 1
      "list": ["大得点系1", "大得点系2", "大得点系3", "大得点系4"]
    "その他系":
      "num": 2
      "list": ["その他系1", "その他系2", "その他系3", "その他系4"]
  }
  ...
  # エイジオブクラフトで遊ぶための準備。
  robot.respond /(エイジオブクラフト|AGE of CRAFT|AGEofCRAFT|Age Of Craft).*/i, (msg) ->
    msg.send "-------------------------"
